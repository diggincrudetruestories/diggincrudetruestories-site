...
let blogName = "Diggin Crude True Stories";
let authorName = "Diggin";
let authorLink = "https://mastodon.social/@diggincrudetruestories"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://neocities.org/'>Neocities!</a></p><p id=psuw>Please stop using windows</p>";
...
let recentPostListHTML = "<h2>Entradas recientes:</h2><ul>";
